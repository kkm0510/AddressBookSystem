...
public class Util {
    ...
    public static final int WRITE_CSV = 2;
    public static final int READ_JSON = 3;
    ...
    public static void whereToPrintContactsStream(Stream<Contact> stream) {
        Scanner sc = new Scanner(System.in);
        while (true) {
            try {
                ...
                sc.nextLine();
                if (choice == 0) return;
                WhereToPrintEnum.values()[choice - 1].printContactStream(stream);
